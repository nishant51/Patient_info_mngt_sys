...
def patient_view_appointment_view(request):
    ...
    if resp.status_code == 200:
        for appointment in appointments:
            if appointment.status != models.Appointment.ACCEPTED:
                appointment.status = models.Appointment.ACCEPTED
                appointment.save()
    else:
        pass

    return render(request,'hospital/patient_view_appointment.html',{'appointments':appointments,'patient':patient,'uid':uid})
